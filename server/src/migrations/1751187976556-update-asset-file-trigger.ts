...
export class UpdateAssetFileTrigger1751187976556 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            create or replace function refresh_collection_sample_files_from_asset_files() returns trigger
                language plpgsql
            as
            $$
            BEGIN
