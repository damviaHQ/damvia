...
const router = createRouter({
	...
	routes: [
		...
		{ name: 'admin-enrichment-overview', path: '/admin/data-enrichment', component: () => import('@/views/admin/admin-enrichment-overview.vue'), meta: { layout: 'admin', title: 'Data enrichment' } },
		...
		{ name: 'admin-matching', path: '/admin/data-enrichment/matching', component: () => import('@/views/admin/admin-matching.vue'), meta: { layout: 'admin', title: 'Matching' } },
		{ name: 'admin-unmatched', path: '/admin/data-enrichment/unmatched', component: () => import('@/views/admin/admin-unmatched.vue'), meta: { layout: 'admin', title: 'Unmatched' } },
