...
const router = createRouter({
	...
	routes: [
		...
		{ name: 'admin-enrichment-overview', path: '/admin/data-enrichment', component: () => import('@/views/admin/admin-enrichment-overview.vue'), meta: { layout: 'admin', title: 'Start here' } },
