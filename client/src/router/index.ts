...
const router = createRouter({
	...
	routes: [
		...
		{ name: 'admin-product-attributes', path: '/admin/products/attributes', component: () => import('@/views/admin/products/admin-product-attributes.vue'), meta: { layout: 'admin', title: 'Record attributes' } },
		...
		{ name: 'admin-page', path: '/admin/pages/:id', component: () => import('@/views/admin/pages/admin-page-edit.vue'), meta: { layout: 'admin', title: 'Edit page' } },
