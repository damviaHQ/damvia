...
export const treeRowClasses = 'cursor-pointer flex h-9 min-w-0 items-center pl-px pr-2 text-body font-medium no-underline text-neutral-600 hover:bg-neutral-200 hover:text-neutral-900'
