...
<template>
  <div class="flex flex-col gap-4">
    <h3 class="text-sm font-semibold">Add files block</h3>
    <FieldGroup>
    ...
    <FieldGroup role="group" :aria-labelledby="`${fieldId}-collection`">
      <Label :id="`${fieldId}-collection`">Use custom collection</Label>
