...
| `asset/assign-products-to-asset-files` | `*/5 * * * *` (every 5 minutes) | Matches every asset file name against `PRODUCT_MATCHING_REGEX` and links it to the record with the captured key. See [Records](../administration/records.md). |
